        ...
        <el-dialog append-to-body :title="currentTitle" :top="top" :visible.sync="currentVisible" :width="width" ref="dialog" v-dialog-drag :modal="true" :fullscreen="fullScreen" :close-on-click-modal="false">
            ...
            <template v-slot:footer>
                ...
                <span class="dialog-footer">
                    ...
                    <el-button size="mini" @click="test">调 试</el-button>
...
export default {
    ...
    methods: {
        ...
        test: function() {
            console.log('this.form test', this.form);
            console.log('this.form test value', this.value);
        },
        open: function(title) {
            if(title == '新增') {
                this.form = this.buildAdd();
                console.log('this.form 新增', this.form);
            }
