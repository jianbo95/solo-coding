<template>
    <cc-dialog ref="packetDialog" show-close :title="title" :width="width">
		<div style="padding:10px;">
			<!-- {{packetData}} -->
			<!-- <el-input type="textarea" v-model="packetData" :autosize="{maxRows: 15}"></el-input> -->
            <textarea spellcheck="false" v-model="packetData" :style="style.textarea + ';width:calc(100% - 10px); outline: none; padding: 5px; border:1px #eee solid;'"></textarea>
		</div>
