...
exports = function () {
    ...
    uploader = WebUploader.create({
        ...
        fileSizeLimit: 50 * 1024 * 1024, // 50 M 上传文件队列总大小。目前50M
        fileSingleSizeLimit: 1 * 1024 * 1024 // 1 M 单个文件大小 目前1M
    });
...
var _Constants = require(parentUrl,'../../app/Constants');

var _Constants2 = _interopRequireDefault(_Constants);

var _SessionUtil = require(parentUrl,'../../app/SessionUtil');
...
;
})('module/test/webuploader-demo.js'); exports; 