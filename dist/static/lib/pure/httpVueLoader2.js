...
var _md = require(parentUrl,'../../../app/util/md5.js');
...
(function umd(root, factory) {
	...
	ScriptContext.prototype = {
		...
		compile: function compile(module) {
			...
			var childModuleRequire = function (childURL) {
				...
				return httpVueLoader.require(parentUrl,resolveURL(this.component.baseURI, childURL));
			}.bind(this);
	...
	Component.prototype = {
		...
		load: function load(componentURL, name) {

			return httpVueLoader.httpRequest(componentURL, name).then(function (obj) {
	...
	httpVueLoader.load = function (url, name) {
		...
		var loadFunc = function loadFunc() {
			...
			var component = new Component(name).load(url, name).then(function (component) {
	...
	httpVueLoader.httpRequest = function (url, name) {
		...
		if (vueCache[url] != null) {
			...
			return new Promise(function (resolve, reject) {
				...
				HttpVuePlus.load(code, xhr._url, name, function (code) {
					resolve({
						code: code,
						xhr: xhr
					});
   ...
   */
			...
			xhr.onreadystatechange = function () {
				...
				if (xhr.readyState === 4) {
					...
					if (xhr.status >= 200 && xhr.status < 300) {
						...
						var js = HttpVuePlus.load(responseText, xhr._url, name, function (code) {
							// Logger.info('xhr', xhr);
	...
	httpVueLoader.langProcessor = {
		...
		less: function (_less) {
			function less(_x) {
				return _less.apply(this, arguments);
			}

			less.toString = function () {
				return _less.toString();
			};
...
exports = window.loader;
})('static/lib/pure/httpVueLoader2.js'); exports; 