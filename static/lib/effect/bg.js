var CanvasParticle = function(body){
    var targetDiv = "app";
	...
	function canvasInit(canvasConfig){
		...
		// var body = document.getElementById(targetDiv);
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById(targetDiv).style.width;
		var height = document.getElementById(targetDiv).style.height;
